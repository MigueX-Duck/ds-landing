// Duck Studios — Sections 4-9: Portfolio, Stories, Dashboards, Social, Risk, Closing.
...
function Portfolio({ lang, openLightbox }) {
...
function Dashboards({ lang, openLightbox }) {
  const ref = useReveal();
  const dashes = [
...
function Social({ lang }) {
  ...
  // Filler text-logos so we have 15 cells
...
Object.assign(window, { Portfolio, Stories, Dashboards, Social, Risk, Closing, Lightbox });