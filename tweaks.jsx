// Duck Studios — Tweaks panel.
// Three expressive controls that reshape the feel:
//   1. Accent palette — swap the brand color across the whole page
//   2. Headline character — Shout / Editorial / Stencil
//   3. Ambience — Theatre / Constellation / Quiet
//
// Defaults live inline in the HTML inside an EDITMODE block so the host
// can persist changes on disk.
...
function applyTweaks(tw) {
  ...
  // Derived gradients that were hard-coded to yellow tokens
...
Object.assign(window, { Tweaks, applyTweaks, PALETTES });
